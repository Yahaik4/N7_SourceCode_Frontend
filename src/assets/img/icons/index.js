const paymentIcons = {
    applePay: require('./apple-pay-og.webp'),
    vnpay: require('./vnpay-logo.webp'),
    momo: require('./momo_1.webp'),
    onepay: require('./onepay-logo.webp'),
    mpos: require('./mpos-logo.webp'),
    kredivi: require('./kredivo-logo.webp'),
